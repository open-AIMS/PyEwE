...
class EwEState:
        ...
        for method_name in dir(self._monitor):
            if not method_name.startswith("_"):
                ...
                if callable(method):
                    ...
                    setattr(
                        self, method_name, partial(getattr(self._monitor, method_name))
                    )
    ...
    def ecotracer_summary(self) -> str:
        ...
        summary += _format_property_line(
            "HasEcotracerLoaded", self.HasEcotracerLoaded()
        )
        summary += _format_property_line(
            "HasEcotracerRanForEcosim", self.HasEcotracerRanForEcosim()
        )
        summary += _format_property_line(
            "HasEcotracerRanForEcospace", self.HasEcotracerRanForEcospace()
        )
        summary += _format_property_line(
            "IsEcotracerModified", self.IsEcotracerModified()
        )
        return summary
    ...
    def ecosim_summary(self) -> str:
        ...
        summary += _format_property_line(
            "HasEcosimInitialized", self.HasEcosimInitialized()
        )
    ...
    def ecopath_summary(self) -> str:
        ...
        summary += _format_property_line(
            "HasEcopathInitialized", self.HasEcopathInitialized()
        )
