...
ECOTRACER_FG_PARAM_PREFIXES = [
    "init_c", "immig_c", "direct_abs_r", "phys_decay_r", "meta_decay_r", "excretion_r"
]
ECOTRACER_FG_SETTER = {
...
def mock_ecotracer(mocker):
    ...
    tracer_m = mocker.Mock(spec=[
        "set_initial_concentrations", "set_immigration_concentrations",
        "set_direct_absorption_rates", "set_physical_decay_rates",
        "set_metabolic_decay_rates", "set_excretion_rates"
    ])
...
class TestParameterManager:
    ...
    def test_set_constant_params(self, ecotracer_manager):
        ...
        assert ecotracer_manager.params["env_init_c"].param_type == ParameterType.CONSTANT
    ...
    def test_set_variable_params(self, ecotracer_manager):
        ...
        assert ecotracer_manager.params["env_init_c"].param_type == ParameterType.VARIABLE
    ...
    def test_apply_constant_params(self, ecotracer_manager, mock_core_interface):
        ...
        mock_core_interface.Ecotracer.set_initial_concentrations.assert_called_with([0], [1])
        mock_core_interface.Ecotracer.set_immigration_concentrations.assert_called_with([0], [2])
        mock_core_interface.Ecotracer.set_direct_absorption_rates.assert_called_with([0], [3])
        mock_core_interface.Ecotracer.set_excretion_rates.assert_called_with([0], [4])
        mock_core_interface.Ecotracer.set_metabolic_decay_rates.assert_called_with([0], [4])
        mock_core_interface.Ecotracer.set_physical_decay_rates.assert_called_with([0], [4])
    ...
    def test_apply_variable_params(self, ecotracer_manager, mock_core_interface):
        ...
        mock_core_interface.Ecotracer.set_initial_concentrations.assert_called_with([6], [1])
        mock_core_interface.Ecotracer.set_immigration_concentrations.assert_called_with([5], [2])
        mock_core_interface.Ecotracer.set_direct_absorption_rates.assert_called_with([4], [3])
        mock_core_interface.Ecotracer.set_excretion_rates.assert_called_with([3], [4])
        mock_core_interface.Ecotracer.set_metabolic_decay_rates.assert_called_with([2], [4])
        mock_core_interface.Ecotracer.set_physical_decay_rates.assert_called_with([1], [4])
